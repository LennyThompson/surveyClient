...
const add_edit_survey_point_1 = require("./add-edit-survey-point");
const webAPI_1 = require("../../../../services/surveyDb/webAPI");
require("./add-survey-point.scss");
let AddSurveyPointComponent = class AddSurveyPointComponent extends add_edit_survey_point_1.AddEditSurveyPoint {
