...
const add_edit_survey_measurement_1 = require("../add/add-edit-survey-measurement");
const webAPI_1 = require("../../../../services/surveyDb/webAPI");
require("./../add/add-survey-measurement.scss");
let EditSurveyMeasurementComponent = class EditSurveyMeasurementComponent extends add_edit_survey_measurement_1.AddEditSurveyMeasurement {
