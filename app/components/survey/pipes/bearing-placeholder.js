...
var BearingPlaceholder = (function () {
    function BearingPlaceholder() {
    }
    BearingPlaceholder.prototype.widthTransform = function (strNumber, width, strPrefix) {
    ...
    BearingPlaceholder.prototype.transform = function (value) {
        var args = [];
