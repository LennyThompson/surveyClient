...
var TraverseMeasurementSummaryComponent = (function () {
    function TraverseMeasurementSummaryComponent() {
    }
    TraverseMeasurementSummaryComponent.prototype.ngOnInit = function () {
        console.log(JSON.stringify(this.m_travMeasurement));
    };
    Object.defineProperty(TraverseMeasurementSummaryComponent.prototype, "TravMeasurement", {
        get: function () {
    ...
    return TraverseMeasurementSummaryComponent;
}());
__decorate([
