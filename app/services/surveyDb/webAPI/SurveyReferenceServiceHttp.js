...
var SurveyReferenceServiceHttp = SurveyReferenceServiceHttp_1 = (function () {
    function SurveyReferenceServiceHttp(httpService) {
    ...
    SurveyReferenceServiceHttp.prototype.loadSurveyReferenceServiceFromDatabase = function (nID) {
        var strPath = SurveyReferenceServiceHttp_1.buildPath(nID);
        return this.httpService.get(strPath)
            .map(function (resp) { return SurveyReference_1.SurveyReference.arrayFromJson(resp.json()); })
            .catch(function (error) { return Rx_1.Observable.throw("error"); });
    };
    SurveyReferenceServiceHttp.buildPath = function (nID) {
