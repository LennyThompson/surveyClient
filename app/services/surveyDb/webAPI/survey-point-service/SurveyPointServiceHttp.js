...
var SurveyPointServiceHttp = SurveyPointServiceHttp_1 = (function () {
    ...
    SurveyPointServiceHttp.prototype.saveToDatabase = function (typeSurveyPoint) {
        ...
        return this.httpService.post(strPath, strJsonBody, options)
            .map(function (resp) { return types_1.SurveyPoint.fromJsonObject(resp.json()); })
    ...
    SurveyPointServiceHttp.prototype.saveSurveyPointForSurvey = function (typeSurveyPoint) {
        ...
        var options = new http_1.RequestOptions({ headers: headers });
        return this.httpService.post(strPath, strJsonBody, options)
            .map(function (resp) { return _this.notifyObservers(types_1.SurveyPoint.fromJsonObject(resp.json())); })
            .catch(function (error) { return Rx_1.Observable.throw(error.json().error || "Server error"); });
    };
    ...
    SurveyPointServiceHttp.prototype.loadAllFromDatabase = function () {
        ...
        return this.httpService.get(strPath)
            .map(function (resp) { return types_1.SurveyPoint.arrayFromJson(resp.json()); })
...
SurveyPointServiceHttp = SurveyPointServiceHttp_1 = __decorate([
    ...
    __metadata("design:paramtypes", [http_1.Http,
        __2.CurrentSurveyProvider,
        __1.SurveyPointSummarySubjectProvider,
        __1.SurveySummarySubjectProvider,
        __1.TraverseSummarySubjectProvider,
        __1.TraverseMeasurementSummarySubjectProvider])
